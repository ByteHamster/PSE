...
\begin{itemize}
 \item Das Menü des Monitors funktioniert manchmal nicht. Man kann dann die Settings nicht mehr öffnen. Das passiert vor allem, wenn man sich am Anfang nicht direkt verbinden kann. Vermutlich handelt es sich um einen JavaFX Fehler.
