...
\newglossaryentry{Dockerimage}
{
  name=Dockerimage,
  plural=Dockerimages,
  description={Ein Linux Container mit Programmen, der unabhängig vom zugrunde liegenden Betriebssystem gleichbleibende Bedingungen herstellt.
  Zum Ausführen ist die Docker Software nötig}
}
...
\newglossaryentry{Fertigungssimulation}
{
  ...
  description={Darstellung der \gls{Produktionsanlage} und Simulieren des Verhaltens}
}
...
{
  name=Jitter,
  description={Simulation von variierenden Werten, um Schwankungen in den Sensorwerten echter Sensoren zu simulieren}
}
...
\newglossaryentry{Produktionsanlage}
{
  ...
  description={Große Fertigungsanlagen, wie sie in der Industrie eingesetzt werden. Hier symbolisiert durch Tanks mit Flüssigkeiten}
}
...
\newglossaryentry{Simulations-Szenario}
{
  ...
  description={Fester, zeitlicher, automatisierter Ablauf zur Veränderung von \glspl{Prozessvariable} der \gls{Fertigungssimulation}, um komplexere Szenarien darzustellen}
}

\newglossaryentry{subtraktive Farbmischung}
{
  name=subtraktive Farbmischung,
  plural=subtraktive Farbmischungen,
  description={Eine Farbmischung, bei der ausgehend von Weiß als Grundfarbe einzelne Farbanteile weggenommen werden}
}
...
\newglossaryentry{Verbindungsinformation}
{
