...
\begin{description}
 ...
 \item [Nichtfunktionale Anforderungen] Sp\"atestens nach 10ms ist die Aktualisierung \"ubernommen und Alarme werden korrekt empfangen.
>>>>>>> [doc] Add Use Case 'Alarm erstellen'.
\end{description}
...
\begin{description}
 ...
 \begin{itemize}[noitemsep]
  ...
  \item Die \gls{Fertigungssimulation} sendet an die registrierte \gls{Uberwachungskonsole} den entsprechenden Alarm.
...
\begin{description}
 ...
 \item [Nichtfunktionale Anforderungen] Die ge\"anderte Alarmbedingung ist nach sp\"atestens 10ms an die Fertigungssimulation \"ubermittelt.
\end{description}
...
\begin{description}
 ...
 \item [Nichtfunktionale Anforderungen] Die L\"oschung der Alarme ist nach sp\"atestens 10ms an die Fertigungssimulation \"ubermittelt.
\end{description}
