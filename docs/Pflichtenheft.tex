...
\begin{itemize}
  \item Die verwendete Produktionsanlage ist ein chemischer Produktionsprozess mit vier Tanks und Flüssigkeiten, die darin gemischt werden.
...
\begin{itemize}
  ...
  \item Die zu verwendende Sprache ist im UI einstellbar.
\end{itemize}

\subsubsection{Überwachungskonsole}
\begin{itemize}
  \item Das Zeitintervall für den Empfang der \glspl{Sensordatum} ist eingestellbar.
  ...
  \item Es gibt über eine Logging-Funktion.
\end{itemize}
