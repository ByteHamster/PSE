...
\begin{itemize}
  ...
  \item Die von den \glspl{OPC UA Client} abgerufenen Werte und deren zeitlicher Verlauf werden graphisch dargestellt. Die Werte sind Zu- und Abflussmengen,
    die Flüssigkeitsfarbe des unteren Tanks sowie die Drehzahl des Mischermotors.
...
\begin{enumerate}
  ...
  \item[FA180] Der linke obere Tank wird mit gelber, der mittlere mit cyanfarbener und der rechte mit magentafarbener Flüssigkeit gefüllt.
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{media/ui-client/ui-uw.png}
...
Neben den Anzeigen der \glspl{Sensordatum} sind auch die Füllstands- und Temperaturverläufe in Form von Graphen und die Alarme enthalten. Im cyanfarbenen Tank ist beispielhaft der Alarm für einen Unterlauf ausgelöst.
