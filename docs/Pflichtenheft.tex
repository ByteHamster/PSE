...
\begin{enumerate}
  ...
  \item[FA90] Die \glspl{OPC UA Client} der \gls{Uberwachungskonsole} k\"onnen sich bei den \glslink{OPC UA Server}{OPC UA Servern} der \gls{Fertigungssimulation} registrieren und dann von
