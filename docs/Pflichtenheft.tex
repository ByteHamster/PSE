...
Es führen Leitungen von den drei oberen Tank zum unteren Tank.
...
\item[FA420] Der Port Überwachungskonsole kann eingestellt werden.
\end{enumerate}
\subsubsection{GUI Darstellung}
\begin{enumerate}
...
Er gibt die Adresse der anderen virtuellen Maschine an und auch der Überwachungskonsole startet erfolgreich. 
...
Es gibt Sensoren für Temperatur, Farbe, Füllstand und Durchfluss der Tanks sowie fuer die Drehzahl des Motors.
