...
/**
 * This is the main window for controlling the OSIP simulation. It provides scroll bars in different
 * tabs for all tanks to adjust their values, like outflow, temperature and motor speed.
 */
