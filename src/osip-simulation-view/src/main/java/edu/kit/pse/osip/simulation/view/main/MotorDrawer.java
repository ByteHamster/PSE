...
public class MotorDrawer extends edu.kit.pse.osip.simulation.view.main.RotatingControlDrawer {
     ...
     * @return
     */
    private double rotateX(double xPos, double centerX, double yPos, double centerY, double degrees) {
     ...
     * @return
     */
    private double rotateY(double xPos, double centerX, double yPos, double centerY, double degrees) {
        double angle = degrees * (Math.PI / 180);
